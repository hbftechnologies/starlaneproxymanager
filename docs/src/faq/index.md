...
Yes! The docker image is multi-arch and is built for a variety of architectures.

## I can't get my service to proxy properly?

Check the [issues page](https://gitea.2eagles.xyz/hft-applications/StarlaneProxyManager/issues) for similar problems or open a new issue.
...
Starlane Proxy Manager itself), most likely the app will also use the `Authorization` header to transmit this information,
